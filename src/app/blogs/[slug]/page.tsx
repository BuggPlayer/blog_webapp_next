...
const page = () => {
  return (
    <>
      ...
      <div className=" mx-5 my-8 border-r-2 border-b-2  grid lg:grid-cols-3  gap-12 ">
        <div className="col-span-2">
          ...
          <div className="text-lg text-gray-600 leading-8">
            ...
            /> */}
            <p className="bg-gray-40  break-all py-2">
        ...
        <div className="sticky top-0  border-l-2  inline-block-2  text-center  w-full p-3   shadow-sm">
